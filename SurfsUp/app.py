...
# Database Setup
#################################################
ngine = create_engine("sqlite:///C:/Users/thegr/Documents/UT Boot Camp/Assignments/Module 10 Assignment - SQLAlchemy/SurfsUp/Resources/hawaii.sqlite")
Base = automap_base()
Base.prepare(autoload_with=ngine)

Station = Base.classes.station
Measurement = Base.classes.measurement

session = Session(ngine)

# Query to get the most recent date in the dataset
most_recent_date = session.query(func.max(Measurement.date)).scalar()

# Convert the date from string format to datetime object
